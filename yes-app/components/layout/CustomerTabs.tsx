...
type ActiveTabType = "home" | "orders" | "track" | "profile";
...
export default function CustomerTabs() {
  ...
  const { user } = useAuth();
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 backdrop-blur-xl bg-white/50 border-t border-gray-200">
      <div className="flex flex-row items-center justify-between px-2 pt-3 pb-6">
        {Tabs.map((tab, index) => (
          <button
            key={tab.name + index}
